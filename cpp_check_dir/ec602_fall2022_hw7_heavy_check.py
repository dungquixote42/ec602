...
class heavyTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.Points = {"first":50,'base10':25,'other':25}
        ...
        cls.msgs = []
        cls.authorlimit = 2
        cls.check_code = False # disable code analysis.
...
programs = ["hw7_heavy.cpp"]

tested_programs = {x:x for x in programs}


testcases={
'hw7_heavy.cpp':heavyTestCase}
