...
class convertbaseTestCase(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.Penalty = {'authors':100,'libraries':100,'brackets':0}
        cls.Points = {"normal":50,'harder':40,"style":10}
